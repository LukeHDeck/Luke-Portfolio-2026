...
export const sectionContent = {
  ...
  '30dmc-spaceflight': {
    ...
    videoUrl: null,
    gallery: [
      { placeholder: true, alt: 'CRT globe overview', caption: '8-bit globe with launch arcs' },
      { placeholder: true, alt: 'Launch arc detail', caption: 'Individual mission arc closeup' },
    ],
  ...
  '30dmc-traffic': {
    ...
    videoUrl: null,
    gallery: [
      { placeholder: true, alt: 'Intersection detail', caption: 'Vehicles responding to traffic signals' },
      { placeholder: true, alt: 'Rush hour overview', caption: 'Full simulation at peak traffic' },
    ],
  ...
  '30dmc-multifamily': {
    ...
    videoUrl: null,
    gallery: [
      { placeholder: true, alt: 'Zoomed-out community view', caption: 'Surface-level parking and POI layer' },
      { placeholder: true, alt: 'Zoomed-in unit view', caption: 'Building breakout showing unit availability' },
    ],
  ...
  '30dmc-tectonic': {
    ...
    videoUrl: null,
    gallery: [
      { placeholder: true, alt: 'Full globe tectonic view', caption: 'Global fault zones and plate interfaces' },
      { placeholder: true, alt: 'Detail of plate boundary', caption: 'Lava-style rendering of tectonic boundary' },
    ],
